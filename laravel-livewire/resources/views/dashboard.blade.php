<x-layouts.app :title="__('Dashboard')">
 ...
 <article class="relative overflow-hidden rounded-3xl border border-cyan-100 bg-gradient-to-br from-white via-cyan-50 to-sky-100 p-8 text-slate-800 shadow-lg transition-colors duration-300 ">
 <div class="pointer-events-none absolute inset-0 -z-10 opacity-40 mix-blend-soft-light ">
 <div class="absolute -right-20 -top-24 h-64 w-64 rounded-full bg-cyan-200/40 blur-3xl "></div>
 <div class="absolute -bottom-24 -left-10 h-64 w-64 rounded-full bg-sky-300/30 blur-3xl "></div>
 </div>

 <div class="flex flex-wrap items-start justify-between gap-6">
 <div class="max-w-xl space-y-3">
 <span class="surface-pill text-xs uppercase tracking-wide text-cyan-600 ">
 ...
 <a href="{{ route('fleet.trucks.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-cyan-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Camiones</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('fleet.drivers.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-cyan-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Conductores</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('fleet.assignments.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-cyan-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Asignaciones</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('fleet.report') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-cyan-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Reportes</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('fleet.maintenance.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-cyan-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 ...
 <a href="{{ route('orders.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-slate-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Pedidos</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('clients.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-slate-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Clientes</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('billing.invoices.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-slate-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Facturas</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 <a href="{{ route('billing.payments.index') }}" class="group surface-muted flex transform items-center justify-between px-4 py-3 text-sm font-semibold text-slate-700 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-white ">
 <span>Pagos</span>
 <span class="text-cyan-500 transition group-hover:translate-x-0.5 ">&rarr;</span>
 </a>
 </div>
 ...
 <span class="surface-pill text-xs font-semibold uppercase tracking-wide text-sky-600 ">1. Gestión de Pedidos y Rutas</span>
 ...
 <div class="mt-6">
 <a href="{{ route('orders.index') }}" class="surface-pill transform text-sky-600 transition hover:-translate-y-0.5 hover:border-sky-300 hover:bg-white ">
 Abrir módulo
 <span>&rarr;</span>
 </a>
 </div>
 ...
 <article class="surface-card p-6">
 <header class="space-y-2">
 <span class="surface-pill text-xs font-semibold uppercase tracking-wide text-indigo-600 ">2. Gestión de Flota y Choferes</span>
 ...
 <div class="mt-6">
 <a href="{{ route('fleet.trucks.index') }}" class="surface-pill transform text-indigo-600 transition hover:-translate-y-0.5 hover:border-indigo-300 hover:bg-white ">
 Abrir módulo
 <span>&rarr;</span>
 </a>
 </div>
 ...
 <article class="surface-card p-6">
 <header class="space-y-2">
 <span class="surface-pill text-xs font-semibold uppercase tracking-wide text-emerald-600 ">3. Facturación y Pagos</span>
 ...
 <div class="mt-6">
 <a href="{{ route('billing.invoices.index') }}" class="surface-pill transform text-emerald-600 transition hover:-translate-y-0.5 hover:border-emerald-300 hover:bg-white ">
 Abrir módulo
 <span>&rarr;</span>
 </a>
 </div>
