<div class="space-y-6">
    ...
    <section class="surface-card w-full max-w-6xl mx-auto">
        ...
        <nav class="grid gap-4 p-6 sm:grid-cols-2 lg:grid-cols-3 text-sm font-semibold text-slate-700 dark:text-slate-200">
            <a href="{{ route('dashboards.logistics') }}" class="group flex items-center justify-between rounded-xl border border-slate-200/70 px-5 py-4 transition hover:-translate-y-0.5 hover:border-indigo-300 hover:bg-white dark:border-slate-800/60 dark:hover:border-indigo-500/60 dark:hover:bg-slate-900">
            ...
            <a href="{{ route('dashboards.fleet') }}" class="group flex items-center justify-between rounded-xl border border-slate-200/70 px-5 py-4 transition hover:-translate-y-0.5 hover:border-indigo-300 hover:bg-white dark:border-slate-800/60 dark:hover:border-indigo-500/60 dark:hover:bg-slate-900">
                <span>{{ __('Panel de flota') }}</span>
                <x-dynamic-component :component="'flux.icon.arrow-right'" class="size-4 text-indigo-500 group-hover:translate-x-0.5" />
            </a>

            <a href="{{ route('dashboards.finance') }}" class="group flex items-center justify-between rounded-xl border border-slate-200/70 px-5 py-4 transition hover:-translate-y-0.5 hover:border-indigo-300 hover:bg-white dark:border-slate-800/60 dark:hover:border-indigo-500/60 dark:hover:bg-slate-900">
