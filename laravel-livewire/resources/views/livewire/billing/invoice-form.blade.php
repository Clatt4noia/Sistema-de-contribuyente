<div class="mx-auto max-w-4xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
 ...
 <input type="text" wire:model.defer="invoice.invoice_number" class="form-control @error('invoice.invoice_number') border-rose-400 @enderror">
 @error('invoice.invoice_number') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field">
 <label class="form-label">Estado *</label>
 <select wire:model.defer="invoice.status" class="form-control @error('invoice.status') border-rose-400 @enderror">
 ...
 <select wire:model.defer="invoice.client_id" class="form-control @error('invoice.client_id') border-rose-400 @enderror">
 ...
 <select wire:model.defer="invoice.order_id" class="form-control @error('invoice.order_id') border-rose-400 @enderror">
 ...
 <select wire:model.defer="invoice.document_type" class="form-control @error('invoice.document_type') border-rose-400 @enderror">
 ...
 <input type="text" wire:model.defer="invoice.series" class="form-control uppercase @error('invoice.series') border-rose-400 @enderror" maxlength="4">
 ...
 <input type="text" wire:model.defer="invoice.correlative" class="form-control @error('invoice.correlative') border-rose-400 @enderror" maxlength="8">
 ...
 <input type="text" wire:model.defer="invoice.ruc_emisor" class="form-control @error('invoice.ruc_emisor') border-rose-400 @enderror" maxlength="11">
 ...
 <input type="text" wire:model.defer="invoice.ruc_receptor" class="form-control @error('invoice.ruc_receptor') border-rose-400 @enderror" maxlength="11">
 @error('invoice.ruc_receptor') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field">
 <label class="form-label">Moneda *</label>
 <select wire:model.defer="invoice.currency" class="form-control @error('invoice.currency') border-rose-400 @enderror">
 ...
 <input type="date" wire:model.defer="invoice.issue_date" class="form-control @error('invoice.issue_date') border-rose-400 @enderror">
 @error('invoice.issue_date') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field">
 <label class="form-label">Fecha de vencimiento</label>
 <input type="date" wire:model.defer="invoice.due_date" class="form-control @error('invoice.due_date') border-rose-400 @enderror">
 @error('invoice.due_date') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field">
 <label class="form-label">Subtotal *</label>
 <input type="number" step="0.01" wire:model.defer="invoice.subtotal" class="form-control @error('invoice.subtotal') border-rose-400 @enderror">
 ...
 <input type="number" step="0.01" wire:model.defer="invoice.taxable_amount" class="form-control @error('invoice.taxable_amount') border-rose-400 @enderror">
 @error('invoice.taxable_amount') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field">
 <label class="form-label">Impuestos</label>
 <input type="number" step="0.01" wire:model.defer="invoice.tax" class="form-control @error('invoice.tax') border-rose-400 @enderror">
 ...
 <input type="number" step="0.01" wire:model.defer="invoice.unaffected_amount" class="form-control @error('invoice.unaffected_amount') border-rose-400 @enderror">
 ...
 <input type="number" step="0.01" wire:model.defer="invoice.exempt_amount" class="form-control @error('invoice.exempt_amount') border-rose-400 @enderror">
 @error('invoice.exempt_amount') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field">
 <label class="form-label">Total</label>
 <input type="number" step="0.01" wire:model.defer="invoice.total" class="form-control @error('invoice.total') border-rose-400 @enderror" placeholder="Se calcula si se deja vacio">
 @error('invoice.total') <span class="text-sm font-medium text-rose-500">{{ $message }}</span> @enderror
 </div>
 <div class="form-field md:col-span-2">
 <label class="form-label">Notas</label>
 <textarea rows="4" wire:model.defer="invoice.notes" class="form-control @error('invoice.notes') border-rose-400 @enderror"></textarea>
