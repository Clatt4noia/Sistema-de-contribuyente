...
<div class="flex flex-col gap-6">
 ...
 <label for="role" class="text-sm font-medium text-zinc-700 ">
 {{ __('Rol de acceso') }}
 </label>
 <select
 id="role"
 wire:model="role"
 required
 class="block w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200 "
 >
