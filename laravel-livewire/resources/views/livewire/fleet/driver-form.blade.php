<div class="mx-auto max-w-6xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex flex-wrap items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100">{{ $isEdit ? 'Editar Chofer' : 'Registrar Chofer' }}</h1>
                ...
                <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">
                    ...
                    <span
                        @class([
                            ...
                            'bg-red-100 text-red-700 dark:bg-red-500/20 dark:text-red-100' => $daysLeft < 0,
                            'bg-yellow-100 text-yellow-700 dark:bg-amber-500/20 dark:text-amber-100' => $daysLeft >= 0 && $daysLeft <= 30,
                            'bg-green-100 text-green-700 dark:bg-emerald-500/20 dark:text-emerald-100' => $daysLeft > 30,
                        ])
                    >
    ...
    <div class="surface-card space-y-8 p-6">
        <form wire:submit.prevent="save" class="space-y-8">
            ...
            <div class="space-y-6 border-t border-slate-200/70 pt-6 dark:border-slate-800/60">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-100">Horarios</h2>
                    <button
                        type="button"
                ...
                <div class="space-y-4">
                    @forelse ($schedules as $index => $schedule)
                        <div
                            ...
                            class="grid grid-cols-1 items-end gap-4 rounded-2xl border border-slate-200/70 bg-slate-50/70 p-4 transition dark:border-slate-800/60 dark:bg-slate-900/40 md:grid-cols-4"
                        >
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-300">Día</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-300">Inicio</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-300">Fin</label>
                    ...
                    @empty
                        <p class="text-sm text-slate-500 dark:text-slate-400">No se han definido horarios. Agrega al menos uno para planificar disponibilidad.</p>
                    @endforelse
                </div>
            </div>
            ...
            <div class="space-y-6 border-t border-slate-200/70 pt-6 dark:border-slate-800/60">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-100">Capacitaciones</h2>
                    <button
                        type="button"
                ...
                <div class="space-y-4">
                    @forelse ($trainings as $index => $training)
                        <div
                            ...
                            class="grid grid-cols-1 gap-4 rounded-2xl border border-indigo-200/60 bg-indigo-50/70 p-4 transition dark:border-indigo-500/40 dark:bg-indigo-500/10 md:grid-cols-6"
                        >
                            <div class="md:col-span-2 space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Nombre *</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Proveedor</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Emitida</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Vence</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Horas</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Estado</label>
                            ...
                            <div class="md:col-span-2 space-y-2">
                                <label class="text-xs font-medium text-slate-600 dark:text-slate-200">Certificado (URL)</label>
                    ...
                    @empty
                        <p class="text-sm text-slate-500 dark:text-slate-400">No se han registrado capacitaciones.</p>
                    @endforelse
                </div>
            </div>
    ...
    @if ($isEdit)
        <livewire:fleet.document-manager :documentable-type="'driver'" :documentable-id="$driver->id" :key="'driver-documents-' . $driver->id" />
    @else
