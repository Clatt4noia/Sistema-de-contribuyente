<div class="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
 ...
 <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900 ">{{ $driver->full_name }}</td>
 <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 ">{{ $driver->document_number }}</td>
 <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 ">{{ $driver->license_number }}</td>
 ...
 @empty
 <tr>
 <td colspan="9" class="px-6 py-4 text-center text-slate-500 ">No se encontraron choferes</td>
 </tr>
 @endforelse
 </tbody>
 </table>
